...
const pb_field_t CommandRequest_fields[8] = {
    ...
    PB_ONEOF_FIELD(argument,   7, MESSAGE , ONEOF, STATIC  , OTHER, CommandRequest, setMotorCalibration, type, &CommandRequest_SetMotorCalibration_fields),
    PB_LAST_FIELD
};
...
const pb_field_t CommandRequest_SetMotorCalibration_fields[5] = {
    PB_FIELD(  1, FLOAT   , OPTIONAL, STATIC  , FIRST, CommandRequest_SetMotorCalibration, steerGain, steerGain, 0),
    PB_FIELD(  2, FLOAT   , OPTIONAL, STATIC  , OTHER, CommandRequest_SetMotorCalibration, speedGain, steerGain, 0),
    PB_FIELD(  3, FLOAT   , OPTIONAL, STATIC  , OTHER, CommandRequest_SetMotorCalibration, steerOffset, speedGain, 0),
    PB_FIELD(  4, FLOAT   , OPTIONAL, STATIC  , OTHER, CommandRequest_SetMotorCalibration, speedOffset, steerOffset, 0),
    PB_LAST_FIELD
};
 ...
 * field descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(ContainerMessage, message.status) < 65536 && pb_membersize(ContainerMessage, message.commandRequest) < 65536 && pb_membersize(ContainerMessage, message.commandResponse) < 65536 && pb_membersize(CommandRequest, argument.setDoorLock) < 65536 && pb_membersize(CommandRequest, argument.ap102Control) < 65536 && pb_membersize(CommandRequest, argument.setMotorCalibration) < 65536 && pb_membersize(CommandResponse, retval.softwareFileVersion) < 65536), YOU_MUST_DEFINE_PB_FIELD_32BIT_FOR_MESSAGES_ContainerMessage_StatusUpdate_CommandRequest_CommandRequest_SetDoorLock_CommandRequest_Ap102Control_CommandRequest_SetMotorCalibration_CommandResponse_CommandResponse_SoftwareFileVersion)
#endif
 ...
 * 8 bit descriptors.
 */
PB_STATIC_ASSERT((pb_membersize(ContainerMessage, message.status) < 256 && pb_membersize(ContainerMessage, message.commandRequest) < 256 && pb_membersize(ContainerMessage, message.commandResponse) < 256 && pb_membersize(CommandRequest, argument.setDoorLock) < 256 && pb_membersize(CommandRequest, argument.ap102Control) < 256 && pb_membersize(CommandRequest, argument.setMotorCalibration) < 256 && pb_membersize(CommandResponse, retval.softwareFileVersion) < 256), YOU_MUST_DEFINE_PB_FIELD_16BIT_FOR_MESSAGES_ContainerMessage_StatusUpdate_CommandRequest_CommandRequest_SetDoorLock_CommandRequest_Ap102Control_CommandRequest_SetMotorCalibration_CommandResponse_CommandResponse_SoftwareFileVersion)
#endif
