...
#define _CommandRequest_TYPE_MAX CommandRequest_TYPE_AP102CTRL
#define _CommandRequest_TYPE_ARRAYSIZE ((CommandRequest_TYPE)(CommandRequest_TYPE_AP102CTRL+1))
